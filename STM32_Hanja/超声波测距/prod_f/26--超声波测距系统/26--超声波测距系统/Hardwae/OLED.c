...
void OLED_ShowFrame(void){
	unsigned int Kanji_width = 16, X=0, Y=0;
{// 测量距离:
	OLED_ShowChinese(X,Y,0);
	OLED_ShowChinese(X+Kanji_width,Y,1);
	OLED_ShowChinese(X+2*Kanji_width,Y,2);
	OLED_ShowChinese(X+3*Kanji_width,Y,3);
	OLED_ShowChinese(X+4*Kanji_width,Y,9);
	OLED_ShowChinese(X+7*Kanji_width,Y,10);
}
{// 警报距离:
	Y += Kanji_width;
	OLED_ShowChinese(X,Y,4);
	OLED_ShowChinese(X+Kanji_width,Y,5);
	OLED_ShowChinese(X+2*Kanji_width,Y,2);
	OLED_ShowChinese(X+3*Kanji_width,Y,3);
	OLED_ShowChinese(X+4*Kanji_width,Y,9);
	OLED_ShowChinese(X+7*Kanji_width,Y,10);
...
{// 占空比:
	...
	OLED_ShowChinese(X+Kanji_width,Y,7);
	OLED_ShowChinese(X+2*Kanji_width,Y,8);
	OLED_ShowChinese(X+3*Kanji_width,Y,9);
	OLED_ShowChinese(X+7*Kanji_width,Y,11);
}
 Y=0;
}
